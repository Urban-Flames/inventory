// src/app/inventory/weekly/spices/page.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { initialSpiceStockData } from '@/data/dailySpicesData';
import { 
  generateWeeklySpicesSummary, 
  loadWeeklySpicesSummary,
  getWeekRange,
  getWeekDates 
} from './actions';
import { 
...
export default function WeeklySpicesPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await generateWeeklySpicesSummary(selectedDate);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight flex items-center gap-2">
            <span>Weekly Spices Report</span>
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* Export Button */}
          <Link href="/inventory/weekly/spices/export">
            <button
