// src/app/inventory/monthly/dry-items/page.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { dryItemsData } from '@/data/dry-items';
import { 
  generateMonthlyDryItemsSummary, 
  loadMonthlyDryItemsSummary,
  getMonthRange
} from './actions';
import { 
  Calendar, 
...
export default function MonthlyDryItemsPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await generateMonthlyDryItemsSummary(selectedDate);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight flex items-center gap-2">
            <span>Monthly Dry Items Report</span>
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* Export Button */}
          <Link href="/inventory/monthly/dry-items/export">
            <button
