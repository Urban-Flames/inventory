// src/app/inventory/monthly/spices/page.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { initialSpiceStockData } from '@/data/dailySpicesData';
import { 
  generateMonthlySpicesSummary, 
  loadMonthlySpicesSummary,
  getMonthRange
} from './actions';
import { 
  Calendar, 
...
export default function MonthlySpicesPage() {
  ...
  const loadData = async () => {
    ...
    try {
      const result = await loadMonthlySpicesSummary(selectedDate);
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await generateMonthlySpicesSummary(selectedDate);
    ...
    <div className="p-4 sm:p-6 space-y-6 sm:space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight flex items-center gap-2">
            <span>Monthly Spices Report</span>
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* Export Button */}
          <Link href="/inventory/monthly/spices/export">
            <button
                                ...
                                <tbody>
                                  {dailyDataForItem.map((day: any) => (
                                    <tr key={day.date} className="border-t border-gray-200">
                                      ...
                                      <td className="p-2 text-center text-orange-600">-{day.production}</td>
                                      <td className="p-2 text-center text-purple-600">-{day.kitchen}</td>
      ...
      {monthlyData.length > 0 && (
        <div className="text-xs text-gray-500 border-t pt-4 space-y-1">
          <p>Month Summary: Opening + Added - Used = Closing</p>
