// src/app/inventory/yearly/bar/page.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { initialBarStockData } from '@/data/barStockItems';
import { 
  generateYearlyBarSummary, 
  loadYearlyBarSummary,
  getYearRange
} from './actions';
import { 
  Calendar, 
...
export default function YearlyBarPage() {
  ...
  const loadData = async () => {
    ...
    try {
      const result = await loadYearlyBarSummary(selectedDate);
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await generateYearlyBarSummary(selectedDate);
    ...
    <div className="p-4 sm:p-6 space-y-6 sm:space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {/* Export Button */}
          <Link href="/inventory/yearly/bar/export">
            <button
                                ...
                                <tbody>
                                  {monthlyDataForItem.map((month: any) => (
                                    <tr key={month.monthStart} className="border-t border-gray-200">
                                      ...
                                      <td className="p-2 text-center text-green-600">+{month.added}</td>
      ...
      {yearlyData.length > 0 && (
        <div className="text-xs text-gray-500 border-t pt-4 space-y-1">
          <p>Year Summary: Opening + Added - Sales - Waste = Closing</p>
