// src/app/inventory/yearly/bar/export/page.tsx
'use client';

import { useState } from 'react';
import { loadYearlyBarSummary, getYearRange } from '../actions';
...
export default function YearlyBarExportPage() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      if (result.success && result.data && result.data.length > 0) {
        ...
        const fileName = `Yearly_Bar_Report_${yearValue}.csv`;
        ...
        setMessage({
          type: 'success',
          text: `Yearly bar report for ${yearValue} exported successfully!`
        });
      } else {
        setMessage({
          type: 'info',
    ...
    <div className="p-4 sm:p-6 max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold">Export Yearly Bar Report</h1>
            <p className="text-sm text-gray-500">Generate CSV report for yearly bar summary</p>
          </div>
        </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>Yearly summary for all bar items</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="font-bold text-blue-600">•</span>
